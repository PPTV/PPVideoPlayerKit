...
extern "C" {
    ...
    PPBOX_DECL PP_int32 PPBOX_DumpOnCrash( PP_char * buf , PP_int32 size );

    PPBOX_DECL void PPBOX_SetStatus(PP_char const * main_type , PP_char const * sub_type,  PP_char const * value );
